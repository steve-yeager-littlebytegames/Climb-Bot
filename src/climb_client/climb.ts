...
export class Admin {
    ...
    constructor(baseUrl?: string, instance?: AxiosInstance) {
        ...
        this.baseUrl = baseUrl ? baseUrl : "http://localhost:44320";
    }

    updateAllLeagues(key: string | null | undefined): Promise<string> {
    ...
    protected processUpdateAllLeagues(response: AxiosResponse): Promise<string> {
...
export class AnalyzerApi {
    ...
    protected processAnalyze(response: AxiosResponse): Promise<AnalyzerData[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
...
export class GameApi {
    ...
    protected processGet(response: AxiosResponse): Promise<GameDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processListAll(response: AxiosResponse): Promise<GameDto[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processAddCharacters(response: AxiosResponse): Promise<CharacterDto[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
...
export class LeagueApi {
    ...
    protected processGetAll(response: AxiosResponse): Promise<LeagueDto[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processCreate(response: AxiosResponse): Promise<LeagueDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processGet(response: AxiosResponse): Promise<LeagueDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processJoin(response: AxiosResponse): Promise<LeagueUserDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processGetSeasons(response: AxiosResponse): Promise<SeasonDto[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processUpdateStandings(response: AxiosResponse): Promise<LeagueDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processSets(response: AxiosResponse): Promise<SetDto[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processGetCompletedSets(response: AxiosResponse): Promise<SetDto[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processGetMembers(response: AxiosResponse): Promise<LeagueUserDto[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processGetMember(response: AxiosResponse): Promise<LeagueUserDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processLeave(response: AxiosResponse): Promise<LeagueUserDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processGetRecentCharacters(response: AxiosResponse): Promise<CharacterDto[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    getSets(leagueUserID: number): Promise<SetDto[]> {
    ...
    protected processGetSets(response: AxiosResponse): Promise<SetDto[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
...
export class SeasonApi {
    ...
    protected processGet(response: AxiosResponse): Promise<SeasonDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processCreate(response: AxiosResponse): Promise<SeasonDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processParticipants(response: AxiosResponse): Promise<SeasonLeagueUserDto[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processStart(response: AxiosResponse): Promise<SetDto[]> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processEnd(response: AxiosResponse): Promise<SeasonDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    updateStandings(id: number): Promise<string> {
    ...
    protected processUpdateStandings(response: AxiosResponse): Promise<string> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processLeave(response: AxiosResponse): Promise<SeasonDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
...
export class SetApi {
    ...
    protected processSubmit(response: AxiosResponse): Promise<SetDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processGet(response: AxiosResponse): Promise<SetDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processChallengeUser(response: AxiosResponse): Promise<SetRequestDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
    ...
    protected processRespondToChallenge(response: AxiosResponse): Promise<SetRequestDto> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
...
export class UserApi {
    ...
    protected processUploadProfilePic(response: AxiosResponse): Promise<string> {
        const status = response.status;
        let _headers: any = {}; 
        if (response.headers && response.headers.forEach) { 
            response.headers.forEach((v: any, k: any) => _headers[k] = v);
